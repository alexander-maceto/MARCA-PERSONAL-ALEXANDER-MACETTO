...
1. Identifica el **dolor, objeción, miedo o duda** del avatar sobre el que quieres crear contenido.
2. Examina y analiza los archivos `.md` de la subcarpeta correspondiente para extraer las ideas que expliquen lo que tu avatar siente.
3. Anota esas ideas en [`../sintesis`](../sintesis) indicando libro y autor, para usarlas como autoridad.
